...
class chl_player_name_stats(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client
    @app_commands.command(name="chl_player_name_stats", description="Look up a college hockey player using a {first name}, {last name}, and {team}")
    async def chl_player_name_stats(self, interaction: discord.Interaction, first_name: str, last_name: str, team: str):
        try:
...
async def setup(client: commands.Bot):
    await client.add_cog(chl_player_name_stats(client))
